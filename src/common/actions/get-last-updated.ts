...
export const getLastUpdated = (lastWorkspaceUPdate: number) => {
  if (lastWorkspaceUPdate < 60 * 60 * 1000) {
    ...
    return Math.round(hrs).toString() + 'min'
  } else if (lastWorkspaceUPdate < 7 * 24 * 60 * 60 * 1000) {
    const weeks = lastWorkspaceUPdate / (24 * 60 * 60 * 1000)
    return Math.round(weeks).toString() + 'min'
  } else if (lastWorkspaceUPdate < 4 * 7 * 24 * 60 * 60 * 1000) {
    const months = lastWorkspaceUPdate / (7 * 24 * 60 * 60 * 1000)
    return Math.round(months).toString() + 'min'
  }
}
