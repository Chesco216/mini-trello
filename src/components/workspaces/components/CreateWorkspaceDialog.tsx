    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-around">
          <button
            type="submit"
            className="cursor-pointer bg-lblue font-semibold text-xl text-white py-3 px-6 rounded-xl"
          >
            Create
          </button>
          <button
            ...
            command="close"
            className="cursor-pointer border-3 border-lblue font-semibold text-xl text-lblue py-3 px-6 rounded-xl"
          >
            Close
          </button>
        </div>
